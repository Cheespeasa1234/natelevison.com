...
exports.tags = exports.posts = void 0;
...
exports.tags = ["this", "update", "learntocode", "programming", "web", "personal", "philosophy", "ideas", "books",
...
function getPost(name) {
    let res = exports.posts.find(post => post.name === name);
    // get the view count
    if (res) {
...
function matchesTags(queryTags, postTags) {
