...
<div class="text-center m-3 p-2 d-flex flex-column justify-content-center align-items-center">
    <h1 class="h2">Website Update Page</h1>
    <h2 class="h4 text-muted">Last update: May 2, 2025</h2>
    <a href="/blog">
        <button class="btn btn-primary back-btn">Back to blog</button>
    </a>
</div>
<div class="posts-container">
    ...
    <UpdatePost id={14} title={"8 months of changes"} date={"Apr 16, 2024, 14:46:28"}>
    ...
    <UpdatePost id={13} title={"RIP cheespeasa1234.github.io"} date={"Aug 1, 2023, 23:23:42"}>
    ...
    <UpdatePost id={12} title={"So much work, I can't even c#"} date={"May 6, 2023, 8:26"}>
        ...
        <p>
            ...
            I have still been programming, although at a lower frequency; mainly because I was studying for the AP test, or I was doing nothing. But I have been working on <a href="https://www.github.com/Cheespeasa/LeviAntSim">Boids simulation</a> to get better at mathematical functions in computer science. I have struggled with angles because it is so difficult to visualize the internal mathematics for debugging purposes.
        </p>
        <p>
    ...
    <UpdatePost id={11} title={"Long time no c++"} date={"May 3, 2023, 10:40"}>
    ...
    <UpdatePost id={10} title={"Absolute grindset"} date={"March 23, 2023, 15:05"}>
    ...
    <UpdatePost id={9} title={"Migration halfway complete"} date={"March 13, 2023, 21:29"}>
        <p>
            ...
            I finished migrating the blog over to the new site. By the way, I didn't post here for a while because I was busy with school.
        </p>
        <p>
    ...
    <UpdatePost id={8} title={"Progress in coding (but not on the site)"} date={"November 18, 2022, 12:36"}>
        ...
        <p>
            ...
            I made some changes to the site (using href instead of onclick) to make it faster. The whole fractal + backend idea to make it more efficient isn't exactly working out for me. I've managed to make a fully functioning express server, but I have yet to implement it into a frontend without php (which I am not great at) or using unsecure methods.
        </p>
        <p>
    ...
    <UpdatePost id={7} title={"full website revamp!"} date={"October 9, 2022, 15:25"} modified={
        [
            { date: "April 11, 2025, 12:10", cause: "Fixed dead links"}
        ]
    }>
        ...
        <ul>
            <li><a href="https://static.natelevison.com/old/downloads">A Java utility class for Arrays</a></li>
            ...
            <li><a href="https://static.natelevison.com/old/mandlebrot">A mandelbrot fractal generator</a></li>
    ...
    <UpdatePost id={6} title={"fixed wordle, moved js and worked on privacy policy"} date={"May 26, 2022, 10:26"} modified={
        [
            { date: "April 11, 2025, 12:12", cause: "" }
        ]
    }>
        ...
        <p>
            ...
            Wassup gamers. I fixed the wordle again, It should be working now. The issue was pretty silly. It had to do with the generate button being after the script which gave nulls and stuff.
        </p>
        <p>
        ...
        <i>
            Update from future Nate. Oh, how innocent I was. How did I not know this is EXACTLY how to cause an XSS vulnerability? Silly me. Well, I've learned a lot.
        </i>
    </UpdatePost>

    <UpdatePost id={5} title={"f*** njsla and i added web spider, github, generators, and removed name"} date={"May 18, 2022, 8:53"}>
    ...
    <UpdatePost id={4} title={"span >> div, punnet square progress??"} date={"May 8, 2022, 3:08 (AM 😳)"}>
    ...
    <UpdatePost id={3} title={"fixed links, thanks thomas, next project?"} date={"May 4, 2022, 12:50"}>
    ...
    <UpdatePost id={2} title={"WordleGen fixed, pme++ updooted, blog went bye bye"} date={"April 18, 2022, 8:57"}>
        ...
        <p>    
            ...
            Hello from Aruba! I am currently in bed in a hotel on Aruba. Pretty cool. Did I mention I'm in Aruba? Anyway, I wanted to talk about my journey to fix the WordleGen and why it broke, and also why it took so long to figure it out.
        </p>
        <p>
        ...
        <p>
            ...
            Also, blog has gone bye bye. I don't want to upkeep it, it's a pain to maintain, (not like I've been maintaining it anyway) but yeah. I think my site will be better off without it.
        </p>
        <p>
    ...
    <UpdatePost id={1} title={"Website Cleanup"} date={"March 24, 2022, 8:29"}>
    ...
    <UpdatePost id={0} title={"The first entry."} date={"March 11, 2022, 12:25"}>
